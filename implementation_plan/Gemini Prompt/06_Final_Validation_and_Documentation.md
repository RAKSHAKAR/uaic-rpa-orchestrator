...
- Execute a complete mock claim workflow in **Attended Mode** (visible system default set browser GUI). Ensure the Anti-Captcha extension loads and resolves challenges visibly/correctly.
...
- Consolidate all implementation data into three authoritative files with proper naming conversion:
